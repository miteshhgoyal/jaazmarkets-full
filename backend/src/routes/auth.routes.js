...
router.get('/users', authenticateToken, authorize(['admin', 'superadmin']), async (req, res) => {
    try {
...
router.patch('/users/:userId/status', authenticateToken, authorize(['admin', 'superadmin']), async (req, res) => {
    try {
