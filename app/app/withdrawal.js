import { View, Text, ScrollView, TouchableOpacity, TextInput, Alert, ActivityIndicator, KeyboardAvoidingView, Platform, Image } from 'react-native'
...
const CRYPTO_OPTIONS = [
    {
        ...
        fee: 1,
        processingTime: 'Automated (within hours)',
    },
    {
        id: 'usdt_erc20',
        name: 'USDT (ERC20)',
...
const Withdrawal = () => {
    ...
    const handleMethodSelection = (method) => {
        ...
        setSelectedCurrency(method.currencyType || 'USDT')
                                ...
                                <View className="px-6 py-6">
                                    ...
                                    {accounts.length === 0 ? (
                                        ...
                                        <>
                                            ...
                                            <View style={{ gap: 12 }}>
                                                {/* Use hardcoded options or API methods */}
                                                        ...
                                                        <View className="flex-row items-center">
                                                            ...
                                                            <View className="flex-1">
                                                                ...
                                                                <Text className="text-xs text-gray-500 mt-1">
                                                                    Min: ${option.minWithdrawal} • Fee: ${option.fee}
                                                                </Text>
                                                            </View>
                                ...
                                <View className="px-6 py-6">
                                    ...
                                    <View className="bg-white rounded-xl border border-gray-200 p-6 mb-4">
                                        ...
                                        <View className="flex-row items-center p-4 bg-gray-50 rounded-lg">
                                            <Text className="text-3xl mr-3">{selectedWithdrawalMethod.icon}</Text>
                                            <View className="flex-1">
                                    ...
                                    <View className="bg-white rounded-xl border border-gray-200 p-6">
                                        <View className="items-center mb-6">
                                            <View className="w-16 h-16 bg-orange-500 rounded-full items-center justify-center mb-4">
                                                <Text className="text-3xl">{selectedWithdrawalMethod.icon}</Text>
                                            </View>
                                            <Text className="text-2xl font-bold text-gray-900 mb-2 text-center">
                                                Confirm Withdrawal
                                            </Text>
